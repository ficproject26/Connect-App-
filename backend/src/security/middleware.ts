...
export const helmetSecurityMiddleware = helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", 'http://localhost:*', 'https://connect-admin-96pc.onrender.com', 'wss://connect-admin-96pc.onrender.com', 'https://api.ficapp.in', 'wss://api.ficapp.in', 'http://13.201.132.46:*', 'wss://*'],
