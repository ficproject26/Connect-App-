      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-7xl mx-auto">
        {branches.map((branch, idx) => (
          <button
            ...
            className="group text-left bg-[#0b132b] hover:bg-[#0f1d3a] border border-slate-800 hover:border-amber-500/50 rounded-2xl p-6 flex flex-col gap-4 transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/10 hover:-translate-y-1 cursor-pointer"
          >
            {/* Office Type */}
            <span className="text-[10px] font-extrabold uppercase tracking-widest text-slate-500 group-hover:text-amber-400 transition-colors">
              {branch.type}
            </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <h3 className={`text-xl font-black ${branch.cityColor} group-hover:text-amber-400 transition-colors`}>
                {branch.city}
              </h3>
            </div>

            {/* Address */}
            <p className="text-slate-400 text-sm leading-relaxed flex-grow group-hover:text-slate-300 transition-colors">
              {branch.address}
            </p>
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-slate-800/80">
              ...
              <span className="text-amber-400 font-bold text-sm tracking-wide">{branch.phone}</span>
            </div>
